...
* <a href="https://bl-mirrotron.github.io/mirrotron-user-guide/">Mirrotron Users guide</a>
* <a href="https://bl-mirrotron.github.io/mirrotron-rf-src-tray/">RF Frequency Source</a>
* <a href="https://bl-mirrotron.github.io/mirrotron-phase-detector-tray/">Four Quadrant IQ Phase Detector</a>
* <a href="https://bl-mirrotron.github.io/gateGen125-tray/">Timing Gate Generator</a>
* <a href="https://bl-mirrotron.github.io/mirrotron-rfq-llrf-timer-cube/">RFQ LLRF Timer Cube</a>
* <a href="https://bl-mirrotron.github.io/mirrotron-llrf-scope-tray/">IQ Monitor System</a>
* <a href="https://bl-mirrotron.github.io/mirrotron-rfpower-scope-tray/">RF Power Monitor System</a>
* <a href="https://bl-mirrotron.github.io/mirrotron-rk-pa-tray/">RF Power Amplifier System</a>
...
* <a href="https://bl-mirrotron.github.io/mirrotron-rfq-flow-tray-inlet/">RFQ Inlet Flow Tray</a>
* <a href="https://bl-mirrotron.github.io/mirrotron-rfq-flow-tray-outlet/">RFQ Outlet Flow Tray</a>
...
## Mirrotron application server
[(contents)](#table-of-contents)<br>
The [server for a Mirrotron control system](https://bl-mirrotron.github.io/mirrotron-box/)  is derived from the Blinky-Lite<sup>TM</sup>Box. The box can be instantiated on a small computer inside a firewall such as Raspberry Pi 3B+ which is more than adequate for a medium size control system or can be hosted  in the cloud.
...
The configuration that provides data to the [Mirrotron application server](https://bl-mirrotron.github.io/mirrotron-box/) can be divided into 5 major subsystems
* [RF source (LLRF)](#rf-source)
* [Timing system](#timing-system)
* [200 MHz RF power amplifier](#200-mhz-rf-power-amplifier)
* [Vacuum system](#vacuum-system)
...
The RF power amplifier takes the low level signal generated from the [RF source](#rf-source) as shown in Figure 1. The amplifier has a 75dB directional coupler mounted  on its output and the forward and reflected RF signals are available on the front panel. These signals are fed into the [RF power monitor](https://bl-mirrotron.github.io/mirrotron-rfpower-scope-tray/).

The <a href="https://rk-microwave.com/" target="_blank">manufacturer</a> of the RF power amplifier provides a remote interface so the RF Power amplifier can be [controlled and monitored](https://bl-mirrotron.github.io/mirrotron-rk-pa-tray/).  
...
## Vacuum system
[(contents)](#table-of-contents)<br>
The RFQ requires ultra-high vacuum for operations. RF power should not be applied to the cavity unless the vacuum pressure inside the cavity is less than 5x10<sup>-5</sup> Pa. The RFQ has two identical vacuum systems mounted on either side of the RFQ as shown in Figure 5. The <a href="https://bl-mirrotron.github.io/mirrotron-rfq-vacuum-tray/">RFQ vacuum system tray</a> is responsible for:
...
The  <a href="https://bl-mirrotron.github.io/nXDS-backing-pump-tray/">backing pump trays</a> are responsible for:
...
* <a href="https://bl-mirrotron.github.io/mirrotron-rfq-temp-tray-inlet/">Inlet temperature tray</a>
* <a href="https://bl-mirrotron.github.io/mirrotron-rfq-flow-tray-inlet/">Inlet flow tray</a>
* <a href="https://bl-mirrotron.github.io/mirrotron-rfq-temp-tray-outlet/">Outlet temperature tray</a>
* <a href="https://bl-mirrotron.github.io/mirrotron-rfq-flow-tray-outlet/">Outlet flow tray</a>
